...
using CoOp.Web.Models.AccountViewModels;
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    var rememberMe = model.RememberMe ?? false;
        ...
        public async Task<IActionResult> ExternalLoginCallback(string returnUrl = null, string remoteError = null)
        {
            ...
            {
                // https://stackoverflow.com/questions/32680412/associate-a-new-google-or-facebook-login-with-an-existing-account
                
                // todo: need to configure auth providers to send email (will be available as claim under provider authenticated user claims)
